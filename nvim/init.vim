...
" Recompile dwmblocks on config edit.
	autocmd BufWritePost ~/.config/dwmblocks/config.h !cd ~/.config/dwmblocks/; sudo make install && { killall -q dwmblocks; setsid -f dwmblocks >/dev/null }
...
" Recompile dmenu on config edit
	autocmd BufWritePost ~/.config/dmenu/config.h !cd ~/.config/dmenu/; sudo make install
" Recompile tabbed on config edit
	autocmd BufWritePost ~/.config/tabbed/config.h !cd ~/.config/tabbed/; sudo make install
